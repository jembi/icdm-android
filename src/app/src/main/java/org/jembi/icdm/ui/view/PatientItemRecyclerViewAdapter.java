...
public class PatientItemRecyclerViewAdapter extends RecyclerView.Adapter<PatientItemRecyclerViewAdapter.ViewHolder> {
    ...
    public PatientItemRecyclerViewAdapter(List<Patient> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.patient_item_fragment, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mContentView.setText(mValues.get(position).mFirstName);
